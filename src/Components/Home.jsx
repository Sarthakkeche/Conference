      ...
      <div className="h-[100vh] relative">
        ...
        >
          {[img1, img2, img3, img4, img5].map((image, index) => (
            <SwiperSlide key={index}>
                <div
                  className="h-full w-full bg-cover bg-center flex flex-row items-center justify-between text-center p-20 mt-12 relative"
                  style={{
                    backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url(${image})`,
                  }}
                >
                  {/* Hero Content */}
                  <div className="flex flex-col items-start justify-center font-playfair display">
                  <h1 className="text-6xl font-bold text-white drop-shadow-lg">ICCSS 2025</h1>
                  <p className="mt-4 text-xl max-w-2xl text-gray-300 font-bold">
                    Curious International Conference on Cyber Security & Smart Systems
                  </p>
                  <p className="mt-4 text-lg max-w-2xl text-gray-300 font-bold ">
                    HOSTING BY D.Y. PATIL COLLEGE OF ENGINEERING, PUNE
                  </p>
                  <p className="mt-4 text-lg max-w-2xl text-gray-300 font-bold ">
                    09-10 May 2025
                  </p>
                  <button className="mt-6 px-8 py-3 bg-blue-500 hover:bg-blue-700 text-white rounded-full text-lg font-semibold shadow-md transition-all duration-300">
                    Submit Paper
                  </button>
                  </div>
