...
<<<<<<< HEAD
                  <a href="https://www.cureusjournals.com/users/sign_in">Submit Paper to Cureus Journals</a>
                  </button>
                  {/* <button className="mt-6 px-6 md:px-8 py-2 md:py-3 bg-blue-500 hover:bg-blue-700 text-white rounded-full text-sm md:text-lg font-semibold shadow-md transition-all duration-300">
                    <Link to="https://www.cureusjournals.com/users/sign_in">Register Here <ArrowOutwardIcon className="mb-1"></ArrowOutwardIcon> </Link>
                  </button> */}</div>
=======
...
>>>>>>> 284db40490876e29971a8288d14b9e9fadb50396
                </div>
