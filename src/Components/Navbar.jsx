...
//        {/* <a href="/guide">Submission Guidelines</a> */}
//       <Link to='/guide' >Submission Guidelines</Link> 
//       </li>
// <li className="hover:bg-blue-100 rounded-md px-3 py-2 transition-colors">
//   <a href="/Topic">Topic of Interest</a>
// </li>
// <li className="hover:bg-blue-100 rounded-md px-3 py-2 transition-colors">
//   <a href="https://www.cureusjournals.com/users/sign_in" target="_blank" rel="noopener noreferrer">
//     Submit Paper
//   </a>
// </li>
...
function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-50 flex justify-between items-center pl-3  pr-3 bg-white text-gray-800 shadow-md">
      ...
      {/* Sidebar for Mobile Menu */}
      <div
        className={`fixed top-0 right-0 h-full w-64 bg-white text-gray-800 transform ${menuOpen ? "translate-x-0" : "translate-x-full"
          } transition-transform duration-300 ease-in-out md:hidden shadow-lg border-l`}>
        <div className="flex justify-between items-center p-6 border-b">
          <h2 className="text-xl font-bold">Menu</h2>
          <button onClick={() => setMenuOpen(false)} className="text-2xl">
        ...
        border-2 border-linear-gradient(to right, red, blue, pink) 1 bg-clip-padding rounded-lg"
              ...
              >
                ...
                <li className="hover:bg-blue-100 rounded-md px-3 py-2 transition-colors">
                  <a href="https://www.cureusjournals.com/users/sign_in" target="_blank" rel="noopener noreferrer">Submit Paper</a>
                </li>
