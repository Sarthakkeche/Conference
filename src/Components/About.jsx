...
function About(){
  ...
  <div class="container px-1 pt-8 pr-50 mx-auto">
    <div class="lg:w-4/5 mx-auto flex flex-wrap ">
      ...
      <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <h1 class="text-gray-900 text-3xl title-font font-medium mb-1 text-4xl font-bold transition-all duration-300 hover:text-transparent hover:bg-clip-text hover:bg-gradient-to-r hover:from-purple-500 hover:via-pink-500 hover:to-red-500 hover:scale-110 w-130">D.Y. Patil College of Engineering</h1>
        
        <p class="leading-relaxed text-justify w-130 ">
